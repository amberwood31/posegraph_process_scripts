...
if __name__ == "__main__":
    ...
    for i in range(0, len(input_filenames)):
        ...
        command = 'rosrun dso_plane_ros dso_plane_ros_imagefile files=/media/amber/www/data/ICL_' + input_template +'_frei_png/rgb calib=/media/amber/www/data/ICL_' + input_template + '_frei_png/camera.txt mode=2 plane=1 nogui=1 nomt=1 planeActive=1 planeAssoci=0'
